...
public abstract class RockMonsterBaseState : State
{

    protected RockMonsterStateMachine stateMachine;

    public RockMonsterBaseState(RockMonsterStateMachine stateMachine)
    {
