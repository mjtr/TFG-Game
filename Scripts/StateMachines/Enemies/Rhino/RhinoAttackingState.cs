...
public class RhinoAttackingState : RhinoBaseState
{
    private readonly int AttackHash = Animator.StringToHash("Attack");
    private const float TransitionDuration = 0.1f;

    private float timeToWaitEndAnimation = 1.3f;

    public RhinoAttackingState(RhinoStateMachine stateMachine) : base(stateMachine)
    {
    }
