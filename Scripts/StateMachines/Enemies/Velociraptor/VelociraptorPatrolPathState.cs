...
public class VelociraptorPatrolPathState : VelociraptorBaseState
{
   ...
   GameObject player;
    ...
    public VelociraptorPatrolPathState(VelociraptorStateMachine stateMachine) : base(stateMachine){  }
