...
public abstract class VelociraptorBaseState : State
{

    protected VelociraptorStateMachine stateMachine;

    public VelociraptorBaseState(VelociraptorStateMachine stateMachine)
    {
