...
public abstract class CrabMonsterBaseState : State
{

    protected CrabMonsterStateMachine stateMachine;

    public CrabMonsterBaseState(CrabMonsterStateMachine stateMachine)
    {
