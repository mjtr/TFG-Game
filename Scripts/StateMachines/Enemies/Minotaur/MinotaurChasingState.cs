...
public class MinotaurChasingState : MinotaurBaseState
{
    ...
    public MinotaurChasingState(MinotaurStateMachine stateMachine) : base(stateMachine)
    {
    }
    ...
    public override void Tick(float deltaTime)
    {
        ...
        if(isInAttackRange()){
            stateMachine.isDetectedPlayed = true;
            stateMachine.SwitchState(new MinotaurAttackingState(stateMachine));
            return;
        }
        ...
        { 
            ...
            stateMachine.SwitchState(new MinotaurIdleState(stateMachine));
            return;
