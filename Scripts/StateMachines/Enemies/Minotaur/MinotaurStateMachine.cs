...
public class MinotaurStateMachine : StateMachine
{
    ...
    [field: SerializeField] public GameObject MinotaurDeathBody;
    ...
    private BaseStats MinotaurBaseStats;
    private AudioController MinotaurAudioController;

    private void Start()
    {
        PlayerHealth = GameObject.FindGameObjectWithTag("Player").GetComponent<Health>();
        MinotaurBaseStats = GetComponent<BaseStats>(); 
        MinotaurAudioController = gameObject.GetComponent<AudioController>();
        ...
        if(PatrolPath != null) 
        { 
            SwitchState(new MinotaurPatrolPathState(this));
        }
        else{ SwitchState(new MinotaurIdleState(this));}
    ...
    private void HandleTakeDamage()
    {
        ...
        {
            DesactiveAllMinotaurWeapon();
            StopAllCoroutines();
            SwitchState(new MinotaurImpactState(this));
        }
    }
    ...
    {
        SwitchState(new MinotaurDeadState(this));
    }
    ...
    public float GetDamageStat(){
        return MinotaurBaseStats.GetStat(Stat.Damage);
    }
    ...
    public void DesactiveAllMinotaurWeapon()
    {
    ...
    public void ActiveAxeMinotaurWeapon()
    {
        WeaponAxeDamage.gameObject.SetActive(true);
    }

    public void ActiveRightFootMinotaurWeapon()
    {
        RightFootDamage.gameObject.SetActive(true);
    }

    public void ActiveLeftFootMinotaurWeapon()
    {
    ...
    public void InstanciateMinotaurDeathBody(){
        if(MinotaurDeathBody == null){return;}
        Instantiate(MinotaurDeathBody, transform.position, transform.rotation);
    }
    ...
    {
        MinotaurAudioController.SetIsMonsterAttacking(newValue);
    }
