...
public class TerrorDragonPatrolPathState : TerrorDragonBaseState
{
 ...
 //   DiabloMover mover;
    ...
    public TerrorDragonPatrolPathState(TerrorDragonStateMachine stateMachine) : base(stateMachine){  }
