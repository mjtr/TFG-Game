...
public abstract class TerrorDragonBaseState : State
{

    protected TerrorDragonStateMachine stateMachine;

    public TerrorDragonBaseState(TerrorDragonStateMachine stateMachine)
    {
