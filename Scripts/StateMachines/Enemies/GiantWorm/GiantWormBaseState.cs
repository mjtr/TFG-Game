...
public abstract class GiantWormBaseState : State
{

    protected GiantWormStateMachine stateMachine;

    public GiantWormBaseState(GiantWormStateMachine stateMachine)
    {
