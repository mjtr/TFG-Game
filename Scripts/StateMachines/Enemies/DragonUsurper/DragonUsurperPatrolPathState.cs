...
public class DragonUsurperPatrolPathState : DragonUsurperBaseState
{
   ...
   GameObject player;
    ...
    public DragonUsurperPatrolPathState(DragonUsurperStateMachine stateMachine) : base(stateMachine){  }
