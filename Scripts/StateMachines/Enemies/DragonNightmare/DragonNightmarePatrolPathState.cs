...
public class DragonNightmarePatrolPathState : DragonNightmareBaseState
{
   ...
   GameObject player;
    ...
    public DragonNightmarePatrolPathState(DragonNightmareStateMachine stateMachine) : base(stateMachine){  }
