...
public abstract class DragonNightmareBaseState : State
{

    protected DragonNightmareStateMachine stateMachine;

    public DragonNightmareBaseState(DragonNightmareStateMachine stateMachine)
    {
