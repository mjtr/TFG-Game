...
public class InfinityDemonPatrolPathState : InfinityDemonBaseState
{
 ...
 //   DiabloMover mover;
    ...
    public InfinityDemonPatrolPathState(InfinityDemonStateMachine stateMachine) : base(stateMachine){  }
