...
public class InfinityDemonAttackingState : InfinityDemonBaseState
{
    private const float TransitionDuration = 0.2f;
    private string attackChoosed;
    public InfinityDemonAttackingState(InfinityDemonStateMachine stateMachine) : base(stateMachine)    {   }
    ...
    {   
        attackChoosed = GetRandomInfinityDemonAttack();
    ...
    {   
        ...
        if(tryCombo)
        {
            tryCombo = GetRandomTryCombo();
            FacePlayer();
            attackChoosed = GetRandomInfinityDemonAttackCombo(attackChoosed);
    ...
    private string GetRandomInfinityDemonAttack()
    {
    ...
    private string GetRandomInfinityDemonAttackCombo(string firstAttack)
    {
        stateMachine.WeaponAxeDamage.SetAttack(stateMachine.GetDamageStat(), stateMachine.AttackKnockback);
