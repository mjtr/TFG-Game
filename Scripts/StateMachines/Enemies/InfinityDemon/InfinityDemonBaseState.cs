...
public abstract class InfinityDemonBaseState : State
{

    protected InfinityDemonStateMachine stateMachine;

    public InfinityDemonBaseState(InfinityDemonStateMachine stateMachine)
    {
    ...
    protected bool BlockAttackRandomize(bool blockBefore)
    {
