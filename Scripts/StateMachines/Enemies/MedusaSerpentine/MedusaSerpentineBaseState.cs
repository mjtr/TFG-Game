...
public abstract class MedusaSerpentineBaseState : State
{

    protected MedusaSerpentineStateMachine stateMachine;

    public MedusaSerpentineBaseState(MedusaSerpentineStateMachine stateMachine)
    {
    ...
    protected bool DodgeAttackRandomize(bool blockBefore)
    {
