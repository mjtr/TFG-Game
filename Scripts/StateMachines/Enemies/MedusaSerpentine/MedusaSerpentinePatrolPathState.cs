...
public class MedusaSerpentinePatrolPathState : MedusaSerpentineBaseState
{
 ...
 //   DiabloMover mover;
    ...
    public MedusaSerpentinePatrolPathState(MedusaSerpentineStateMachine stateMachine) : base(stateMachine){  }
