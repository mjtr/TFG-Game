...
public abstract class SoulEaterDragonBaseState : State
{

    protected SoulEaterDragonStateMachine stateMachine;

    public SoulEaterDragonBaseState(SoulEaterDragonStateMachine stateMachine)
    {
