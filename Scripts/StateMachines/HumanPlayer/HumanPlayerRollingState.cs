...
public class HumanPlayerRollingState : HumanPlayerBaseState
{
    ...
    public HumanPlayerRollingState(HumanPlayerStateMachine stateMachine, Vector3 rollingDirectionInput) : base(stateMachine)
    {
