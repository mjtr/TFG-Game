...
public class HumanPlayerDodgingState : HumanPlayerBaseState
{
    ...
    public HumanPlayerDodgingState(HumanPlayerStateMachine stateMachine, Vector3 dodgingDirectionInput) : base(stateMachine)
    {
