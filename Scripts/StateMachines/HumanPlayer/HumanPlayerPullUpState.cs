...
public class HumanPlayerPullUpState : HumanPlayerBaseState
{
    ...
    public HumanPlayerPullUpState(HumanPlayerStateMachine stateMachine) : base(stateMachine)
    {
    }
    ...
    public override void Tick(float deltaTime)
    {
        ...
        stateMachine.SwitchState(new HumanPlayerFreeLookState(stateMachine,false));   
    }
