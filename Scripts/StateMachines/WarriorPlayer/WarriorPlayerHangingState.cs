...
public class WarriorPlayerHangingState : WarriorPlayerBaseState
{
    ...
    public WarriorPlayerHangingState(WarriorPlayerStateMachine stateMachine, Vector3 ledgeForward, Vector3 closestPoint) : base(stateMachine)
    { 
    ...
    public override void Tick(float deltaTime)
    {
        ...
        {
            stateMachine.SwitchState(new WarriorPlayerPullUpState(stateMachine));
        }
