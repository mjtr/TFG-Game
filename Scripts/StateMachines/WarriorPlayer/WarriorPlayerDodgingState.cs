...
public class WarriorPlayerDodgingState : WarriorPlayerBaseState
{
    ...
    public WarriorPlayerDodgingState(WarriorPlayerStateMachine stateMachine, Vector3 dodgingDirectionInput) : base(stateMachine)
    {
    ...
    public override void Enter()
    {
        ...
        stateMachine.Stamina.TakeStamina(stateMachine.DodgeStaminaTaked);
